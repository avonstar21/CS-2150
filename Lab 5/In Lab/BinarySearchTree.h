...
private:
    ...
    void insertHelp(BinaryNode*
    & n, const string& x);
    bool findHelp(BinaryNode*const& n, const string& x) const;
    int numNodesHelp(BinaryNode*const& n) const;
    string pathToHelp(BinaryNode*const& n, const string& x) const;
};
